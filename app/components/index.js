...
// Dashboard Widget :: Principal / Teacher / Student / Admin :: Starts Here
export TodayFeeChartWidget from './Widget/TodayFeeChartWidget';
export MonthlyFeeChartWidget from './Widget/MonthlyFeeChartWidget';
export YearlyFeeChartWidget from './Widget/YearlyFeeChartWidget';
export TodayFacaultyAttendenceChartWidget from './Widget/TodayFacaultyAttendenceChartWidget';
export TodayStudentAttendenceChartWidget from './Widget/TodayStudentAttendenceChartWidget';
export StudentAverageAttendenceChartWidget from './Widget/StudentAverageAttendenceChartWidget';
export ClasswiseStudentsAdmissionChartWidget from './Widget/ClasswiseStudentsAdmissionChartWidget';
export GenderwiseStudentsStrengthChartWidget from './Widget/GenderwiseStudentsStrengthChartWidget';
export ReligionWisePieChartWidget from './Widget/ReligionWisePieChartWidget';
export CastWisePieChartWidget from './Widget/CastWisePieChartWidget';
export ActivityDateWidget from './Widget/ActivityDateWidget';
export ActivityTimelineWidget from './Widget/ActivityTimelineWidget';
export MyMessageWidget from './Widget/MyMessageWidget';
export MyTaskWidget from './Widget/MyTaskWidget';
export TeacherCounterChartWidget from './Widget/TeacherCounterChartWidget';
export AssignmentOverviewWidget from './Widget/AssignmentOverviewWidget';
export CalendarActivityDateWidget from './Widget/CalendarActivityDateWidget';
export SubjectAverageChartWidget from './Widget/SubjectAverageChartWidget';
export PredictiveAnalysisChartWidget from './Widget/PredictiveAnalysisChartWidget';
export HomeworkTaskWidget from './Widget/HomeworkTaskWidget';
export StudentHouseChartWidget from './Widget/StudentHouseChartWidget';
export StudentStrengthCastwiseChartWidget from './Widget/StudentStrengthCastwiseChartWidget';
export StudentBloodgroupChartWidget from './Widget/StudentBloodgroupChartWidget';
export MyNotesWidget from './Widget/MyNotesWidget';
// Dashboard Widget :: Principal / Teacher / Student / Admin :: Ends Here
