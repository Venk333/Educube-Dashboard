...
function MyMessageWidget(props) {
  ...
  return (
    <PapperBlock whiteBg noMargin title="My Activities" icon="ion-ios-stats-outline" desc="">
        ...
        <Grid item md={12} xs={12}>
          <Fragment>
            ...
            <Paper className={classes.rootContact}>
              <AppBar position="static" color="default">
                ...
                <Hidden smDown>
                  ...
                  >
                    ...
                    <Tab
                      label={(
                        <Badge className={classes.tabNotif} color="primary">
                          Parent Messages
                        </Badge>
                      )}
                      icon={<Chat />}
              ...
              {value === 0 && <TabContainer><MessagesListStyled openMenu={handleOpen} /></TabContainer>}
...
MyMessageWidget.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MyMessageWidget);
