...
import { dataAdmin1 } from '../../api/chart/chartMiniData';
...
function AdminSchoolFeeWidget(props) {
  const { classes } = props;
  return (
    <PapperBlock whiteBg noMargin title="School wise Mode of Transport " icon="ion-ios-stats-outline" desc="">
            ...
            <div className={classes.chartFluid2}>
              <ResponsiveContainer width={1000} height="100%">
                ...
                >
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="Bus" fillOpacity="1" fill={color.third} />
                  <Bar dataKey="Bicycle" fillOpacity="0.8" fill={color.fourth} />
                  <Bar dataKey="Parents" fillOpacity="0.8" fill={color.secondary} />
                  <Bar dataKey="Others" fillOpacity="0.8" fill={color.primary} />
                  {/* <Bar dataKey="Bus" stackId="a" fillOpacity="0.8" fill={color.third} />
          <Bar dataKey="Bicycle" stackId="a" fillOpacity="0.8" fill={color.fourth} />
          <Bar dataKey="Parents" stackId="a" fillOpacity="0.8" fill={color.secondary } />
          <Bar dataKey="Others" stackId="a" fillOpacity="0.8" fill={color.primary} />  */}
