...
import {
  ...
  PrincipalDashboard, TeacherDashboard, StudentDashboard, AdminDashboard,
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        <Route path="/app/dashboard-principal" component={PrincipalDashboard} />
        <Route path="/app/dashboard-teacher" component={TeacherDashboard} />
        <Route path="/app/dashboard-student" component={StudentDashboard} />
